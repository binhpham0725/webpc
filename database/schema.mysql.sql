...
INSERT IGNORE INTO users (id, role, full_name, email, password_hash, phone, company, address, city, note, avatar_label, avatar_url, created_at, updated_at) VALUES
    (1, 'admin', 'Admin ĐộPICI', 'admin@webpc.local', '$2y$10$8zT08NJr/Dg81LAouKxCzOF2XTwyrkJ/95manx2d1P3Wvva3ULL7m', '0900000000', 'ĐộPICI', '1 Green Glass St', 'Ha Noi', 'Tài khoản admin demo cho khu vực quản trị.', 'AD', '', '2026-04-29 00:00:00', '2026-04-29 00:00:00');
...
INSERT IGNORE INTO services (id, slug, title, eta_label, price_label, description, cover_image, sort_order) VALUES
    (1, 'build-custom', 'Lắp máy theo yêu cầu', 'Trong 24 giờ', 'Từ 300.000 đ', 'Chốt cấu hình theo workload, ngân sách và khả năng nâng cấp.', 'https://images.unsplash.com/photo-1593640408182-31c70c8268f5?auto=format&fit=crop&w=1200&q=80', 1),
    (2, 'upgrade-pc', 'Nâng cấp thiết bị', '2-4 giờ', 'Từ 250.000 đ', 'Phân tích bottleneck và đề xuất luồng nâng cấp hợp lý.', 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80', 2),
    (3, 'clean-and-repaste', 'Vệ sinh và thay keo tản nhiệt', '90 phút', 'Từ 180.000 đ', 'Làm sạch bụi, thay keo tản và test lại nhiệt độ.', 'https://images.unsplash.com/photo-1580894908361-967195033215?auto=format&fit=crop&w=1200&q=80', 3),
    (4, 'workspace-setup', 'Bố trí không gian làm việc', 'Theo lịch hẹn', 'Từ 500.000 đ', 'Tư vấn monitor, dock, webcam, router và bố trí dây gọn.', 'https://images.unsplash.com/photo-1496171367470-9ed9a91ea931?auto=format&fit=crop&w=1200&q=80', 4);
...
INSERT IGNORE INTO payment_methods (id, user_id, method_type, bank_name, account_mask, account_ref, holder_name, note, created_at) VALUES
    (1, 1, 'bank_transfer', 'Ngân hàng ABC', '**** 9845', '9845', 'ADMIN ĐỘPICI', 'Tài khoản demo cho admin.', '2026-04-29 00:00:00');
